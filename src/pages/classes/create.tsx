                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                >
                                                    <FormControl>
                                                        <SelectTrigger className="w-full bg-white placeholder:text-gray-600">
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input className={
                                                        "bg-white placeholder:text-gray-600"
                                                    }
                                                        type="number"
                                                        placeholder="30"
                                                        onChange={(e) => {
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Textarea className={"bg-white placeholder:text-gray-600"}
